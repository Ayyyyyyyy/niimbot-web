...
import { X, Settings as SettingsIcon, Server, Key, RefreshCw, Loader2, Save, Check, Sparkles } from 'lucide-react';
import {
    getLLMSettings,
    saveLLMSettings,
            ...
            <div className="bg-panel-bg rounded-xl shadow-2xl w-full max-w-2xl max-h-[85vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    <section>
                            ...
                            <div className="space-y-4 p-4 bg-gray-800/50 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        >
                                            {isDiscovering ? <Loader2 size={16} className="animate-spin" /> : <RefreshCw size={16} />}
                                            Discover
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    {ollamaModels.length === 0 && (
                                        <p className="text-xs text-gray-500 mt-1">Click Discover to find available models</p>
                                    )}
                                </div>
                            </div>
                        )}
                            ...
                            <div className="space-y-4 p-4 bg-gray-800/50 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">
                                        Get your API key from <a href="https://aistudio.google.com/apikey" target="_blank" rel="noopener noreferrer" className="text-highlight hover:underline">Google AI Studio</a>
                                    </p>
                                </div>
                        ...
                        {/* Discovery Status */}
                        {discoveryStatus && (
                            <div className={`mt-4 text-sm p-3 rounded-lg ${discoveryStatus.success ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'
                                }`}>
