 ...
 */
export function Toolbar({ onAddText, onAddBarcode, onAddQRCode, onAddShape, onAddLine, onAddImage, onOpenTemplates, onOpenAI, activeTool }) {
    const tools = [
                ...
                <div className="space-y-3">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => onUpdateProperty('charSpacing', parseInt(e.target.value, 10))}
                            className="w-full"
                        />
                    </div>
            ...
            <div className="space-y-3 pt-2 border-t border-gray-700">
                ...
                <div>
                    ...
                    <input
                        ...
                        onBlur={(e) => {
                            const val = parseInt(e.target.value, 10);
                            if (!isNaN(val)) onUpdateProperty('angle', val);
                        }}
                        onKeyDown={(e) => { if (e.key === 'Enter') e.target.blur(); }}
                        className="w-full"
                    />
